...
if(isset($dba) && isset($css)) {
	$dba->Query("INSERT INTO ". STYLES ." (id, name, description) VALUES (NULL, 'vB3', 'Look alike of vB3')");
	...
	$css->AddClass(".forum_base", "background-color: #FFFFFF; width: 770px;", $styleset, "This is the table which surounds the entire forum.");
	$css->AddClass(".forum_base table", "background-color: #D1D1E1;", $styleset, "This just applies a white background to tables within the forum.");
	$css->AddClass(".forum_content", "border: 1px solid #0B198C;", $styleset, "content within the forum");
	$css->AddClass(".forum_footer", "margin-right: 10px; margin-left: 10px;", $styleset, "The forum''''s footer");
	$css->AddClass(".forum_header", "background-color: #D1D1E1; border: 1px solid #0B198C; padding: 1px; margin-left: 10px; margin-right: 10px; margin-top: 10px;  ", $styleset, "The forum''''s header");
	$css->AddClass(".forum_main", "margin-left: 10px; margin-right: 10px;", $styleset, "Goeas around all interior content");
	...
	$css->AddClass("div.alt1", "top: 10px; position: relative;", $styleset, "This is each navigation table.");
	...
	$css->AddClass(".tcat, .tcat td", "font-family: verdana, geneva, lucida, arial, helvetica, sans-serif;font-weight: bold;color: #FFFFFF;background-color: #5C7099;background-repeat: repeat-x;background-position: top left;background-image:url(Images/Descent/Uploads/gradient_tcat.gif);", $styleset, "This is the main header region.");
	$css->AddClass(".thead", "font-family: tahoma, verdana, geneva, lucida, arial, helvetica, sans-serif;font-size: 11px;font-weight: bold;color: #FFFFFF;background-color: #869BBF;background-repeat: repeat-x;background-position: top left;background-image:url(Images/Descent/Uploads/gradient_thead.gif);", $styleset, "This is the secondary header region.");
	...
	$css->AddClass("body", "background-color: #E1E1E2;margin:0px 0px 0px 0px;padding:0px 0px 0px 0px;", $styleset, "This sets the body of the page''''s properties.");
	$css->AddClass("fieldset", "border: 1px solid #003366;padding: 10px;margin: 3px;", $styleset, "This applies to every fieldset. (those cool table like things with a name which intersects the top border.");
