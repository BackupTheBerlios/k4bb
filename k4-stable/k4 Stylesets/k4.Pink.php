...
if(isset($dba) && isset($css)) {
	$dba->Query("INSERT INTO ". STYLES ." (name, description) VALUES ('Pink', 'PinkGuru')");
	...
	$css->AddClass(".alt1", "background-color: #FFCCCC;color: #000000;", $styleset, "This goes for some of the lighter background colored things.");
	...
	$css->AddClass(".alt3", "background-color: #FF9999;color: #000000;", $styleset, "This goes for some of the darkest background colored things.");
	...
	$css->AddClass(".forum_base", "width: 770px;", $styleset, "This is the table which surounds the entire forum.");
	...
	$css->AddClass(".panel", "background-color: #FFEBEB;color: #000000;padding: 10px;border: outset 2px;", $styleset, "This is the main light background colored region, and when put on a table column directly; applies an outset border.");
	...
	$css->AddClass(".tcat, .tcat td", "background-color: #AA3333;color: #FFFFFF;font-weight: bold;font-family: verdana, geneva, lucida, arial, helvetica, sans-serif;", $styleset, "This is the main header region.");
	$css->AddClass(".thead", "background-color: #666666;color: #FFFFFF;font-size: 11px;font-weight: bold;font-family: tahoma, verdana, geneva, lucida, arial, helvetica, sans-serif;", $styleset, "This is the secondary header region.");
