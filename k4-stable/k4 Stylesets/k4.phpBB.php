...
if(isset($dba) && isset($css)) {
	...
	$css->AddClass(".forum_base", "width: 99%;background-color:#FFFFFF;padding:2px;border:1px solid #98AAB1;", $styleset, "This is the table which surounds the entire forum.");
