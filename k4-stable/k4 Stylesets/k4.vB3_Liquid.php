...
if(isset($dba) && isset($css)) {
	$dba->Query("INSERT INTO ". STYLES ." (id, name, description) VALUES (NULL, 'vB3 Liquid', 'Look alike of vB3')");
	...
	$css->AddClass(".forum_base", "background-color: #FFFFFF; width: 99%;", $styleset, "This is the table which surounds the entire forum.");
	...
	$css->AddClass("div.alt1", "margin-top: 15px;", $styleset, "This is each navigation table.");
